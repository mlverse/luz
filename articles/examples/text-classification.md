...
This example is a port of [‘Text classification from
scratch’](https://keras.io/examples/nlp/text_classification_from_scratch/)
from Keras documentation by Mark Omerick and François Chollet.
...
- Downloads the IMDB dataset if it doesn’t exist in the `root`
  directory.
...
starting with an embedding layer and we plug a classifier at the output.
