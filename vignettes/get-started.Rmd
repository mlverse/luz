...
As much as possible, Luz tries to reuse the existing structures from Torch. A model in Luz is defined identically as you would define it if using raw Torch. For a specific example, this is the definition of a feedforward CNN that can be used to classify digits from the MNIST dataset:
